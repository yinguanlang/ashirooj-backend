...
import com.ashiro.ashirooj.constant.FileConstant;
import com.ashiro.ashirooj.exception.BusinessException;
import com.ashiro.ashirooj.manager.CosManager;
import com.ashiro.ashirooj.model.dto.file.UploadFileRequest;
import com.ashiro.ashirooj.model.entity.User;
import com.ashiro.ashirooj.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        //存储桶存储位置
        String filepath = String.format("/%s/%s/%s/%s", "ashiro-picture", fileUploadBizEnum.getValue(), loginUser.getId(), filename);
        File file = null;
        try {
            // 上传文件
